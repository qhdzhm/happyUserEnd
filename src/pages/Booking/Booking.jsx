...
..."
        ...
        <Form onSubmit={handleSubmit}>
          <Row>
                    ...
                    <Form.Group as={Col} md={6} className="mb-3">
                      ...
                      <div className="position-relative">
                        <DatePicker
                          ...
                          onChange={(date) =>
                            enhancedHandleDateChange("tour_start_date", date)
                          }
                          dateFormat="yyyy-MM-dd"
                          className="form-control"
                          placeholderText="选择行程开始日期"
                          isInvalid={!!validationErrors.tour_start_date}
                          isClearable={false}
                          showMonthDropdown
                          showYearDropdown
                          dropdownMode="select"
                      ...
                      <Form.Control.Feedback type="invalid">
                        {validationErrors.tour_start_date}
                      </Form.Control.Feedback>
                    </Form.Group>
                    <Form.Group as={Col} md={6} className="mb-3">
                      ...
                      <div className="position-relative">
                        <DatePicker
                          ...
                          onChange={(date) =>
                            enhancedHandleDateChange("tour_end_date", date)
                          }
                          dateFormat="yyyy-MM-dd"
                          className="form-control"
                          placeholderText="选择行程结束日期"
                          isInvalid={!!validationErrors.tour_end_date}
                          minDate={formData.tour_start_date}
                          isClearable={false}
                          showMonthDropdown
                          showYearDropdown
                      ...
                      <Form.Control.Feedback type="invalid">
                        {validationErrors.tour_end_date}
                      </Form.Control.Feedback>
                    </Form.Group>
                  </Row>
                      ...
                      <Row>
                        <Form.Group as={Col} md={6} className="mb-3">
                          ...
                          <Form.Control
                            ...
                            isInvalid={!!validationErrors.arrival_flight}
                            className="flight-input-field"
                          />
                          <Form.Control.Feedback type="invalid">
                            {validationErrors.arrival_flight}
                          </Form.Control.Feedback>
                          <Form.Text className="text-muted">
                            填写航班号以便安排接机服务
                          </Form.Text>
                        ...
                        <Form.Group as={Col} md={6} className="mb-3">
                          ...
                          <Form.Control
                            ...
                            isInvalid={!!validationErrors.departure_flight}
                            className="flight-input-field"
                          />
                          <Form.Control.Feedback type="invalid">
                            {validationErrors.departure_flight}
                          </Form.Control.Feedback>
                          <Form.Text className="text-muted">
                            填写航班号以便安排送机服务
                          </Form.Text>
                        ...
                        <Form.Group as={Col} md={6} className="mb-3">
                          ...
                          <div className="position-relative">
                            <DatePicker
                              ...
                              onChange={date => enhancedHandleDateChange('arrival_departure_time', date)}
                              showTimeSelect
                              timeFormat="HH:mm"
                              timeIntervals={15}
                              timeCaption="时间"
                              ...
                              isInvalid={!!validationErrors.arrival_departure_time}
                        ...
                        <Form.Group as={Col} md={6} className="mb-3">
                          ...
                          <div className="position-relative">
                            <DatePicker
                              ...
                              onChange={date => enhancedHandleDateChange('arrival_landing_time', date)}
                              showTimeSelect
                              timeFormat="HH:mm"
                              timeIntervals={15}
                              timeCaption="时间"
                              ...
                              isInvalid={!!validationErrors.arrival_landing_time}
                              showTimeSelectOnly={false}
                              timeInputLabel="时间："
                              showTimeInput={false}
                              popperClassName="date-time-popper"
                        ...
                        <Form.Group as={Col} md={6} className="mb-3">
                          ...
                          <div className="position-relative">
                            <DatePicker
                              ...
                              onChange={date => enhancedHandleDateChange('departure_departure_time', date)}
                              showTimeSelect
                              timeFormat="HH:mm"
                              timeIntervals={15}
                              timeCaption="时间"
                              ...
                              className="form-control date-time-picker"
                              placeholderText="选择起飞时间"
                              isInvalid={!!validationErrors.departure_departure_time}
                              showTimeSelectOnly={false}
                              timeInputLabel="时间："
                              showTimeInput={false}
                              popperClassName="date-time-popper"
                        ...
                        <Form.Group as={Col} md={6} className="mb-3">
                          ...
                          <div className="position-relative">
                            <DatePicker
                              ...
                              onChange={date => enhancedHandleDateChange('departure_landing_time', date)}
                              showTimeSelect
                              timeFormat="HH:mm"
                              timeIntervals={15}
                              timeCaption="时间"
                              ...
                              className="form-control date-time-picker"
                              placeholderText="选择降落时间"
                              isInvalid={!!validationErrors.departure_landing_time}
                              showTimeSelectOnly={false}
                              timeInputLabel="时间："
                              showTimeInput={false}
                              popperClassName="date-time-popper"
            ...
            <Col lg={5}>
              <div className="sticky-sidebar">
                {/* 产品信息卡片 */}
                <div className="tour-summary mb-4">
                  <Card className="mb-4 shadow tour-info-card">
                    ...
                    <Card.Body>
                      <div className="mb-3">
                        <h5 className="mb-2 text-primary">{tourDetails?.title || tourName}</h5>
                ...
                {/* 订单摘要卡片 */}
                <Card className="shadow order-summary">
                  ...
                  <Card.Body>
                    <div className="mb-3">
                        ...
                        <div>
                          ...
                          <span>
                            {formData.tour_start_date && formData.tour_end_date
                              ? ` ${formatDate(
                                  formData.tour_start_date
                                )}至${formatDate(formData.tour_end_date)}`
                              : " 日期待定"}
                          </span>
                        </div>
                      </div>
                      {tourDetails && (
                        <div className="mt-2 small bg-light p-2 rounded">
                          <div>
                            <strong>跟团游</strong>{" "}
                            {priceDetails.adultCount || formData.adult_count}
                            成人{" "}
                            {priceDetails.childCount || formData.child_count}
                            儿童
                          </div>
                          <div>
                            <strong>行程天数:</strong>{" "}
                            {tourDetails.duration || 0}天{" "}
                            <strong>酒店晚数:</strong> {getHotelNights()}晚
                          </div>
                        </div>
                      )}
                    </div>
                    ...
                    <ListGroup variant="flush" className="price-list">
                      <ListGroup.Item className="d-flex justify-content-between align-items-center border-0 px-0">
                        <div>
                          <span className="fw-medium">成人</span>
                          <small className="text-muted ms-2">
                            ¥{priceDetails.discountedPrice?.toFixed(2)} ×{" "}
                            {priceDetails.adultCount}
                          </small>
                        </div>
                        <span>¥{priceDetails.adultTotalPrice?.toFixed(2) || priceDetails.basePrice?.toFixed(2)}</span>
                      </ListGroup.Item>

                      {priceDetails.childCount > 0 && (
                        <ListGroup.Item className="d-flex justify-content-between align-items-center border-0 px-0">
                          <div>
                            <span className="fw-medium">儿童</span>
                            <small className="text-muted ms-2">
                              ¥{priceDetails.childUnitPrice?.toFixed(2)} ×{" "}
                              {priceDetails.childCount}
                            </small>
                          </div>
                          <span>
                            ¥
                            {priceDetails.childrenTotalPrice?.toFixed(2) || (
                              priceDetails.childUnitPrice *
                              priceDetails.childCount
                            ).toFixed(2)}
                          </span>
                        </ListGroup.Item>
                      ...
                      {(tourType || "").toLowerCase().includes("group") && (
                        <>
                          <ListGroup.Item className="d-flex justify-content-between align-items-center border-0 px-0">
                            <div>
                              <span className="fw-medium">酒店</span>
                              <small className="text-muted ms-2">
                                {priceDetails.baseHotelLevel || "4星"} ×{" "}
                                  {getHotelNights()}晚
                              </small>
                            </div>
                            <span>包含</span>
                          ...
                          {priceDetails.extraRoomFee > 0 && (
                            <ListGroup.Item className="d-flex justify-content-between align-items-center border-0 px-0">
                              <div>
                                <span className="fw-medium">单房差</span>
                                <small className="text-muted ms-2">
                                  {priceDetails.extraRooms || "额外"}间 ×{" "}
                                  {priceDetails.hotelNights || getHotelNights()}
                                  晚
                                </small>
                              </div>
                              <span className="text-danger">
                                +¥{priceDetails.extraRoomFee?.toFixed(2)}
                              </span>
                            </ListGroup.Item>
                          )}

                          {/* 显示酒店升级差价 */}
                          {false && priceDetails.hotelPriceDifference !== 0 && (
                            <ListGroup.Item className="d-flex justify-content-between align-items-center border-0 px-0">
                              <div>
                                <span className="fw-medium">酒店升级差价</span>
                                <small className="text-muted ms-2">
                                  ¥{Math.abs(priceDetails.hotelPriceDifference)}{" "}
                                  × {priceDetails.roomCount}间 ×{" "}
                                  {priceDetails.hotelNights}晚
                                </small>
                              </div>
                              <span
                                className={
                              ...
                              >
                                ...
                                ¥
                                {Math.abs(
                                  priceDetails.hotelPriceDifference *
                                    priceDetails.roomCount *
                                    priceDetails.hotelNights
                                ).toFixed(2)}
                              </span>
                            </ListGroup.Item>
                          )}
                      ...
                      {/* 显示原价（如果有折扣） */}
                      {priceDetails.nonAgentPrice > 0 &&
                        priceDetails.nonAgentPrice !==
                          parseFloat(calculateTotalPrice()) && (
                          <ListGroup.Item className="d-flex justify-content-between align-items-center text-muted border-0 px-0">
                            <span>原价</span>
                            <span>
                              <s>¥{priceDetails.nonAgentPrice.toFixed(2)}</s>
                            </span>
                          </ListGroup.Item>
                        )}
                      ...
                      {isAgent && priceDetails.agentDiscount > 0 && (
                        <ListGroup.Item className="d-flex justify-content-between align-items-center text-success border-0 px-0">
                          <span>代理商折扣</span>
                      ...
                      <ListGroup.Item className="d-flex justify-content-between align-items-center fw-bold border-0 px-0">
                        <span>总计</span>
                    ...
                    <div className="mt-3 payment-info">
                      <div className="d-flex align-items-center mb-2">
                ...
                {/* 帮助信息卡片 */}
                <Card className="shadow help-card">
                  <Card.Header className="bg-light">
                    <h5 className="mb-0">
                  ...
                  <Card.Body>
                    <div className="d-flex align-items-center mb-3">
                      ...
                      <div>
                        <div className="fw-bold">客服支持</div>
                    ...
                    <div className="contact-info">
                      <div className="d-flex align-items-center mb-2">
                        ...
                        <span>+61 (3) 6234 5678</span>
                      </div>
                      <div className="d-flex align-items-center">
                        <FaWeixin className="text-success me-2" />
                        <span>HappyTassieTravel</span>
                      </div>
                    </div>
                  </Card.Body>
                </Card>
          ...
          {/* 移动端固定在底部的提交按钮 */}
          <div className="d-lg-none fixed-bottom bg-white shadow-lg p-3">
            <div className="d-flex justify-content-between align-items-center mb-2">
