    ...
    <Container className="order-success-page py-5">
      ...
      <div className="order-status mb-5">
        <div className="status-steps d-flex justify-content-center">
          <div className="status-step completed text-center">
          ...
          <div className="status-step active text-center">
            <div className="step-icon">
              <span>2</span>
            </div>
          ...
          <div className="status-line"></div>
          <div className="status-step text-center">
            <div className="step-icon">
              <span>3</span>
            </div>
          ...
          <div className="status-step text-center">
            ...
            <div className="step-label">开始旅行</div>
          </div>
        </div>
      </div>
